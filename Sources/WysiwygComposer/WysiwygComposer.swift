...
private extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_wysiwyg_composer_910d_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_wysiwyg_composer_910d_rustbuffer_free(self, $0) }
    }
}
...
public class ComposerAction: ComposerActionProtocol {
    ...
    deinit {
        try! rustCall { ffi_wysiwyg_composer_910d_ComposerAction_object_free(pointer, $0) }
    }
    ...
    public func actionId() -> String {
        return try! FfiConverterString.lift(
            try!
                rustCall {
                    wysiwyg_composer_910d_ComposerAction_action_id(self.pointer, $0)
                }
        )
    }
    ...
    public func action() -> ActionRequest {
        return try! FfiConverterTypeActionRequest.lift(
            try!
                rustCall {
                    wysiwyg_composer_910d_ComposerAction_action(self.pointer, $0)
                }
        )
    }
}

private struct FfiConverterTypeComposerAction: FfiConverter {
...
public protocol ComposerModelProtocol {
    func select(startUtf16Codeunit: UInt32, endUtf16Codeunit: UInt32)
...
public class ComposerModel: ComposerModelProtocol {
    ...
    deinit {
        try! rustCall { ffi_wysiwyg_composer_910d_ComposerModel_object_free(pointer, $0) }
    }

    public func select(startUtf16Codeunit: UInt32, endUtf16Codeunit: UInt32) {
        try!
            rustCall {
                wysiwyg_composer_910d_ComposerModel_select(self.pointer,
    ...
    public func replaceText(newText: String) -> ComposerUpdate {
        return try! FfiConverterTypeComposerUpdate.lift(
            try!
                rustCall {
                    wysiwyg_composer_910d_ComposerModel_replace_text(self.pointer,
    ...
    public func replaceTextIn(newText: String, start: UInt32, end: UInt32) -> ComposerUpdate {
        return try! FfiConverterTypeComposerUpdate.lift(
            try!
                rustCall {
                    wysiwyg_composer_910d_ComposerModel_replace_text_in(self.pointer,
    ...
    public func backspace() -> ComposerUpdate {
        return try! FfiConverterTypeComposerUpdate.lift(
            try!
                rustCall {
                    wysiwyg_composer_910d_ComposerModel_backspace(self.pointer, $0)
                }
        )
    }
    ...
    public func delete() -> ComposerUpdate {
        return try! FfiConverterTypeComposerUpdate.lift(
            try!
                rustCall {
                    wysiwyg_composer_910d_ComposerModel_delete(self.pointer, $0)
                }
        )
    }
    ...
    public func deleteIn(start: UInt32, end: UInt32) -> ComposerUpdate {
        return try! FfiConverterTypeComposerUpdate.lift(
            try!
                rustCall {
                    wysiwyg_composer_910d_ComposerModel_delete_in(self.pointer,
                                                                  FfiConverterUInt32.lower(start),
                                                                  FfiConverterUInt32.lower(end), $0)
                }
        )
    ...
    public func enter() -> ComposerUpdate {
        return try! FfiConverterTypeComposerUpdate.lift(
            try!
                rustCall {
                    wysiwyg_composer_910d_ComposerModel_enter(self.pointer, $0)
                }
        )
    }
    ...
    public func bold() -> ComposerUpdate {
        return try! FfiConverterTypeComposerUpdate.lift(
            try!
                rustCall {
                    wysiwyg_composer_910d_ComposerModel_bold(self.pointer, $0)
                }
        )
    }
    ...
    public func dumpState() -> ComposerState {
        return try! FfiConverterTypeComposerState.lift(
            try!
                rustCall {
                    wysiwyg_composer_910d_ComposerModel_dump_state(self.pointer, $0)
                }
        )
    }
    ...
    public func actionResponse(actionId: String, response: ActionResponse) -> ComposerUpdate {
        return try! FfiConverterTypeComposerUpdate.lift(
            try!
                rustCall {
                    wysiwyg_composer_910d_ComposerModel_action_response(self.pointer,
...
public class ComposerUpdate: ComposerUpdateProtocol {
    ...
    deinit {
        try! rustCall { ffi_wysiwyg_composer_910d_ComposerUpdate_object_free(pointer, $0) }
    }
    ...
    public func textUpdate() -> TextUpdate {
        return try! FfiConverterTypeTextUpdate.lift(
            try!
                rustCall {
                    wysiwyg_composer_910d_ComposerUpdate_text_update(self.pointer, $0)
                }
        )
    }
    ...
    public func menuState() -> MenuState {
        return try! FfiConverterTypeMenuState.lift(
            try!
                rustCall {
                    wysiwyg_composer_910d_ComposerUpdate_menu_state(self.pointer, $0)
                }
        )
    }
    ...
    public func actions() -> [ComposerAction] {
        return try! FfiConverterSequenceTypeComposerAction.lift(
            try!
                rustCall {
                    wysiwyg_composer_910d_ComposerUpdate_actions(self.pointer, $0)
                }
        )
    }
}
...
private struct FfiConverterTypeActionRequest: FfiConverterRustBuffer {
...
private struct FfiConverterTypeActionResponse: FfiConverterRustBuffer {
...
public func newComposerModel() -> ComposerModel {
    return try! FfiConverterTypeComposerModel.lift(
        try!
            ...
            rustCall {
                wysiwyg_composer_910d_new_composer_model($0)
            }
    )
}
